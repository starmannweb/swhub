    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 rounded-xl bg-gradient-to-r from-violet-600/20 to-purple-600/10 border border-violet-500/10 px-6 py-5">
                ...
                <div>
                    <h1 className="text-xl font-bold text-white">Tutoriais em Vídeo</h1>
                    <p className="text-sm text-gray-400">Assista, aplique e publique mais rápido.</p>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-5">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-bold text-white">{currentAula.title}</h2>
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                ...
                                className="border-white/10 text-gray-400 hover:text-white hover:bg-white/[0.06] disabled:opacity-30"
                            >
                ...
                {/* Playlist Sidebar */}
                <div className="w-full lg:w-[320px] shrink-0 rounded-xl bg-[#12142a] border border-white/[0.06] flex flex-col overflow-hidden">
                    {/* Playlist Header */}
                    <div className="p-4 border-b border-white/[0.06]">
                        <div className="flex items-center justify-between mb-3">
                            <h3 className="text-sm font-bold text-white">Aulas</h3>
                            <span className="text-xs text-gray-500">{currentIndex + 1}/{AULAS.length}</span>
                        </div>
                        {/* Progress bar */}
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-9 h-9 bg-[#0d0f1a] border-white/[0.06] text-white text-xs placeholder:text-gray-600"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto max-h-[500px]">
                        {filteredAulas.length === 0 ? (
                            <div className="p-6 text-center">
                                <p className="text-xs text-gray-600">Nenhuma aula encontrada.</p>
                            </div>
                        ) : (
                            <div className="divide-y divide-white/[0.04]">
                                {filteredAulas.map((aula) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            {/* Thumbnail */}
                                            <div className="relative shrink-0 w-24 h-14 rounded-lg overflow-hidden bg-[#0d0f1a]">
                                                <img
